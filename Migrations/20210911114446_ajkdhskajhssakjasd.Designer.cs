...
namespace new_project.Migrations
{
    ...
    [Migration("20210911114446_ajkdhskajhssakjasd")]
    partial class ajkdhskajhssakjasd
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("new_project.Models.Project", b =>
                {
            ...
            modelBuilder.Entity("new_project.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("new_project.Models.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("new_project.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("new_project.Models.User", b =>
                {
                    b.HasOne("new_project.Models.Project", null)
                        .WithMany("workers")
